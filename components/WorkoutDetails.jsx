...
export default function WorkoutDetails({ workout }) {
    ...
    return (
        <main className="min-h-screen bg-[#0F1115] text-white">
            ...
            {toast.message && (
                <div
                    className={`fixed bottom-6 left-1/2 z-50 -translate-x-1/2 rounded-xl border px-5 py-3 text-sm font-medium shadow-lg ${toast.type === "error"
                            ? "border-red-500/40 bg-red-950 text-red-200"
                            : "border-[#2D313B] bg-[#1B1F28] text-white"
                        }`}
                >
                    {toast.message}
                </div>
